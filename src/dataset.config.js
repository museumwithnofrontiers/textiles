...
export default {
  ...
  home: {
    title: 'textiles.identity.title',
    intro: 'textiles.home.intro',
    cards: [
      {
        title: 'textiles.nav.catalogue',
        description: 'textiles.home.catalogueText',
    ...
    featured: {
      entity: 'items',
      heading: 'textiles.home.itemOnDisplay',
  ...
  navigation: {
    ...
    links: [
      ...
      { section: 'catalogue', label: 'textiles.nav.catalogue', to: { name: 'catalogue' } },
      { section: 'about', label: 'textiles.nav.about', to: { name: 'about' } },
    ],
  },
  ...
  //
  //   extraViews: [
  //     ...standardRoutes('gallery', { creditsBody: 'textiles.credits.body' }),
  ...
  //       partnerObjects: {
  //         emptyPartner: 'textiles.partnerObjects.emptyPartner',
  //         emptyInstitution: 'textiles.partnerObjects.emptyInstitution',
  //         institutionSummary: 'textiles.partner.monumentsInExhibition',
  //         partnerProfileLabel: 'textiles.partnerObjects.partnerProfile',
  //         institutionProfileLabel: 'textiles.partnerObjects.institutionProfile',
  //       },
  //     }),
  //     // + this website's own routes: home, item, collection entrance,
  //     // timeline entrance, partners entrance
