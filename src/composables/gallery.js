...
// `useGalleryData.js` used to be byte-identical local copies of what textiles
...
// legacy project key, no UUID — textiles shares the same entity list and
...
export const itemSheet = {
  ...
  related: {
    ...
    // Since inventory-app#1807 (textiles-data 1.0.11+), an outside
