...
The **Museum With No Frontiers — Textiles** gallery, built from the published
dataset `@museumwnf/textiles-data`.
...
| Package | Role |
| --- | --- |
| `@museumwnf/textiles-data` | the dataset (JSON + `manifest.json`) |
...
<https://museumwithnofrontiers.github.io/textiles/> through the reusable workflows in
